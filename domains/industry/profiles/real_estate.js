export default {
  ...
  recommendationTemplates: [
    { type: "listing_post", tier: "core", title: "Post a New Listing", description: "Promote a property with key details to attract buyers.", priority: "high", guidance: "Create a 'just listed' post highlighting a property's best features. Include address, price, bedrooms, bathrooms, square footage, and unique selling points. Make it scroll-stopping.", conditions: { hasData: true, requiredDataType: "listing" } },
